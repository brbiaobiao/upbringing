...
import com.outsourcing.library.utils.CornerUtils;
import com.outsourcing.library.widget.dialog.entry.DialogMenuItem;
...
public class ActionSheetDialog extends BottomBaseDialog{
    ...
    /**
     * item Highlight textcolor(ListView item文字颜色)
     */
    private int itemHighlightColor = Color.parseColor("#ff3b30");
    ...
    private OnOpenItemClickL mOnOpenItemClickL;
    ...
    public void setOnOpenItemClickL(OnOpenItemClickL onOpenItemClickL) {
        this.mOnOpenItemClickL = onOpenItemClickL;
    }
    ...
    public View onCreateView() {
        ...
        lv.setLayoutParams(new LinearLayout.LayoutParams(LinearLayout.LayoutParams.MATCH_PARENT, LinearLayout.LayoutParams.WRAP_CONTENT, 1));
    ...
    public void setUiBeforShow() {
        ...
        tv_title.setBackgroundDrawable(CornerUtils.cornerDrawable(titleBgColor, new float[] { radius, radius, radius, radius, 0, 0, 0, 0 }));
        ...
        /** title underline */
        v_line_title.setLayoutParams(new LinearLayout.LayoutParams(LinearLayout.LayoutParams.MATCH_PARENT, dp2px(dividerHeight_DP)));
        ...
        TextPaint tp = tv_cancel.getPaint();
        ...
        lv.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
                if (mOnOpenItemClickL != null) {
                    mOnOpenItemClickL.onOpenItemClick(parent, view, position, id);
                }
            }
        });
    ...
    /**
     * set itemHighlight textcolor(item高亮字体颜色)
     *
     * @param itemHighlightColor
     * @return ActionSheetDialog
     */
    public ActionSheetDialog itemHighlightColor(int itemHighlightColor) {
    ...
    class ListDialogAdapter extends BaseAdapter {
        ...
        public View getView(int position, View convertView, ViewGroup parent) {
            ...
            tv_item.setTextColor(item.highlight?itemHighlightColor:itemTextColor);
            ...
            float radius = dp2px(cornerRadius_DP);
            if (isTitleShow) {
                ll_item.setBackgroundDrawable((CornerUtils.listItemSelector(radius, Color.TRANSPARENT, itemPressColor, position == contents.size() - 1)));
            } else {
                ll_item.setBackgroundDrawable(CornerUtils.listItemSelector(radius, Color.TRANSPARENT, itemPressColor, contents.size(), position));
            }
